        ...
        <table id="myTable" class="table table-striped">
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td>{{ $d->email }}</td>
                  <td>
                      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal-{{ $key }}" style="margin: 5px auto; display: block; padding: 5px;width:100%;">See video</button>
                       <a class="btn btn-warning" href="{{ $d->video_url }}" download style="margin: 5px auto; display: block; padding: 5px;">Download video</a>
